...
var i;i=n.originalEvent.touches?n.originalEvent.touches[0]:n;var t=i.clientX-M;if(1==H&&0!=t&&(H=2,N=z*-q),2==H){

n.preventDefault();var e=1;(0==z&&i.clientX>M||z==Q-1&&i.clientX<M)&&(e=3),j=N+t/e,T(!1),x(j)}
...
B.after('<ul class="sw-bullet"></ul>');for(var i=B.parent().find(".sw-bullet"),t=0;n>t;t++){

0==t?i.append('<li class="sw-slide-'+t+' active"></li>'):i.append('<li class="sw-slide-'+t+'"></li>');var e=D.find(".sw-slide-"+t);!function(n){
...
var i=0;i=0==n?Q-3:n==Q-1?0:n-1,D.find(".sw-bullet").find("li").removeClass("active"),D.find(".sw-slide-"+i).addClass("active")}

var D=this,B=this.find(".sw-slides"),C={

transitionDuration:500,autoPlay:!0,autoPlayTimeout:4e3,timingFunction:"ease-out",prevNextButtons:!0,bullets:!0,swipe:!0,sliderHeight:"60%"}

,F=n.extend(C,i),H=0,M=0,N=0,j=0,z=0,Q=0,q=0,A=!0,G=F.transitionDuration,I=F.swipe,J=F.autoPlayTimeout,K=void 0,L=!0,O=F.autoPlay;return function(){
